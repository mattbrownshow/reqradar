  ...
  return (
    <div className="px-4 sm:px-6 py-8 lg:py-12">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Active Opportunities</h1>
        ...
        {filtered.length === 0 && !isLoading ? (
          sourceFilter === "all" ? (
            <div className="bg-white border border-gray-200 rounded-2xl p-12 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">No active opportunities yet</h3>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-12 text-center">
              <Briefcase className="w-16 h-16 text-gray-300 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-gray-900 mb-2">No opportunities from {sourceFilter === "job-boards" ? "job boards" : "target companies"} yet</h3>
              <p className="text-gray-600 mb-6">Your {sourceFilter === "job-boards" ? "job board feeds haven't" : "target companies haven't"} found matching roles. Try expanding your search criteria.</p>
