  ...
  return (
    <div className="px-4 sm:px-6 py-8 space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Connect with Decision Makers</h1>
          <p className="text-sm text-gray-500 mt-2">Generate AI-personalized messages to hiring managers and key stakeholders at your target companies.</p>
        </div>
      ...
      {filtered.length === 0 ? (
        <EmptyState
          ...
          description="Create outreach campaigns to engage with decision makers."
